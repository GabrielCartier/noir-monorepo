...
// The implementation contract ABI
export const BEETS_STAKING_IMPLEMENTATION_ABI = [
...
// Combined ABI for use in the service
export const BEETS_STAKING_ABI = [
  ...BEETS_STAKING_PROXY_ABI,
  ...BEETS_STAKING_IMPLEMENTATION_ABI,
] as const;
