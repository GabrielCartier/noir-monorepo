...
// type UnstakeSContent = z.infer<typeof unstakeSContentSchema>;
...
// async function unstakeS(
//   params: UnstakeSContent & { runtime: IAgentRuntime },
// ): Promise<UnstakeSResponse> {
//   try {
//     const parsedParams = unstakeSContentSchema.parse(params);
//     const {
//       userId,
//       amount,
//       userVaultAddress,
...
//           });
//           throw new Error(
//             'Could not find stS transfer event in unstake receipt',
//           );
//         }
...
//         elizaLogger.info('Successfully completed unstakeS operation', {
//           userId,
//           amount,
//           stsAmount: stsAmount.toString(),
...
//         elizaLogger.error('Transaction failed in unstakeS', {
...
//       elizaLogger.error('Error in unstakeS operation', {
...
// export const unstakeSAction: Action = {
//   name: 'UNSTAKE_S',
//   description: 'Unstakes $stS tokens to receive $S tokens in the vault',
//   similes: ['WITHDRAW_S', 'UNSTAKE_SONIC', 'WITHDRAW_SONIC', 'UNSTAKE_TOKENS'],
//   examples: [
//     [
//       {
//         user: '{{user1}}',
//         content: {
//           text: 'Unstake my $stS tokens',
//           action: 'UNSTAKE_S',
//         },
//       },
//       {
//         user: '{{agentName}}',
//         content: {
//           text: 'Successfully unstaked your $stS tokens',
//           action: 'UNSTAKE_S',
//         },
//       },
//     ],
...
//   ) => {
//     try {
//       elizaLogger.log('Unstake S handler called');
...
//       const amountResponse = amountContent.object as UnstakingResponse;
...
//       const unstakeSContent: UnstakeSContent = {
...
//       const unstakeResponse = await unstakeS({
//         ...unstakeSContent,
//         runtime,
//       });
...
//         if (callback) {
//           callback({
//             text: `Successfully unstaked ${amountResponse.amount} $stS tokens from vault ${vaultAddress} and received ${unstakeResponse.stsAmount} $S tokens`,
//             content: {
//               success: true,
//               stsAmount: unstakeResponse.stsAmount,
//               transactionHash: unstakeResponse.transactionHash,
//               action: 'UNSTAKE_S',
...
//         return true;
//       }
//       throw new Error(unstakeResponse.error || 'Failed to unstake $stS tokens');
//     } catch (error) {
//       elizaLogger.error(
//         'Error in unstake S handler:',
